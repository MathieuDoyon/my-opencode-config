...
| Product Frameworks | [Jobs-to-be-Done](./skills/jobs-to-be-done/SKILL.md), [Business Model Canvas](./skills/business-model-canvas/SKILL.md), [Hooked Model](./skills/hooked-model/SKILL.md), [Fogg Behavior Model](./skills/fogg-behavior-model/SKILL.md), [product decisions](./skills/making-product-decisions/SKILL.md) |
